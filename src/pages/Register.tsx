      ...
      <div className="max-w-md w-full space-y-8 bg-card p-8 rounded border border-line shadow-sm">
        ...
        <form className="mt-6 space-y-6" onSubmit={handleSubmit}>
          ...
          <div className="space-y-4">
            ...
            <div>
              <label className="block text-sm font-medium text-ink mb-1" htmlFor="role">
                I am a...
              </label>
              <select
                id="role"
                ...
                className="mt-1 block w-full pl-3 pr-10 py-2.5 text-base border-line focus:outline-none focus:ring-1 focus:ring-navy focus:border-navy sm:text-sm rounded border bg-white text-ink"
              >
        ...
        <div className="text-center text-sm text-muted mt-4">
          ...
          <Link to="/login" className="font-medium text-navy hover:text-navy-2 transition-colors">
            Sign in here
          </Link>
        </div>
      </div>
